...
type ReceivedMessage struct {
	...
	SessionId *wrapperspb.StringValue `protobuf:"bytes,3,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	InReplyTo *wrapperspb.StringValue `protobuf:"bytes,4,opt,name=in_reply_to,json=inReplyTo,proto3" json:"in_reply_to,omitempty"`
...
type ActiveMessagingChannelState struct {
	...
	ReplyToken     *MessageReplyToken          `protobuf:"bytes,4,opt,name=reply_token,json=replyToken,proto3" json:"reply_token,omitempty"`
	Sessions       []*CompleteMessagingSession `protobuf:"bytes,5,rep,name=sessions,proto3" json:"sessions,omitempty"`
	AllowedAt      *timestamppb.Timestamp      `protobuf:"bytes,6,opt,name=allowed_at,json=allowedAt,proto3" json:"allowed_at,omitempty"`
}
