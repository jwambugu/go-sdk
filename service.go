...
type (
	...
	Service interface {
		...
		AddCustomerReminderByTag(reminder *Reminder, tag *Tag) (*hera.TagCommandReply, error)
		...
		CancelCustomerReminderByTag(key string, tag *Tag) (*hera.TagCommandReply, error)
		...
		UpdateCustomerSecondaryId(customer *Customer, secondaryIds []CustomerSecondaryId) (*hera.UpdateCustomerStateReply, error)
		// DeleteCustomerSecondaryId deletes an associated secondary id from a customer
		DeleteCustomerSecondaryId(customer *Customer, secondaryIds []CustomerSecondaryId) (*hera.UpdateCustomerStateReply, error)
